...
<div class="menu-grid" id="menu_grid">
	 ...
	 <div class="menu-layout <?= $posConfig ['config'] ['root_layout'] ?> mt-3"><?php echo $this->element ($posConfig ['config'] ['root_layout']) ?></div>
	 ...
	 <div class="modal fade" id="create_modal" aria-hidden="fales" tabindex="-1">
		  <div class="modal-dialog modal-dialog-scrollable">
				<div class="modal-content">
					 <div id="create_modal_header" class="modal-header">
						  <span id="modal_title"><?= __ ('Create button') ?></span>
						  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					 </div>
					 <div id="create_modal_content" class="modal-body">
						  ...
						  <div class="row g-3 mt-3">
								<div class="col-sm-9 d-grid text-center"></div>
 								<div class="col-sm-3 d-grid text-center">
									 <button id="create_button_continue" class="btn btn-primary" data-bs-dismiss="modal"><?= __ ('Continue') ?></button>
								</div>
						  </div>
	 ...
	 <script>
	  ...
	  $('#create_button_continue').click (function (e) {
