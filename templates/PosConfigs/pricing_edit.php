...
echo $this->Form->create (null, ['id' => 'pricing', 'name' => 'pricing']);
...
<fieldset class="maintenance-border">
	 ...
	 <legend class="maintenance-border"><?= $pricingDesc ?></legend>

	 <div class="container">
		  
		  <div class="row top30">
				
				<div class="col-sm-2 text-right top10"><?= __('Name') ?></div>
				
				<div class="col-sm-2 text-right top10">
		  ...
		  <div class="row top10">
				...
				<div class="col-sm-2 text-right top10"><?= __('Description') ?></div>
				
				<div class="col-sm-4 text-right top10">
		  ...
		  <div class="row top30">
				...
				<div class="col-sm-2 text-right top10"></div>
				
				<div class="col-sm-8 text-center top10">
					 
					 <div class="container">
						  
						  <div class="row top10 grid-cell-separator">
