<?= $this->Html->css ("Items/size_pricing") ?>
...
<form id="item_edit" name="item_edit">
	 ...
	 <?= $this->Form->hidden ('item[item_price][class]', ['value' => 'size']) ?>
	 ...
	 <div class="size-pricing-sizes-grid grid-cell-separator">
		  
		  <div class="grid-cell grid-cell-left grid-cell-separator "><?= __ ('Size Description') ?></div>
...
<?= $this->Html->script ("Items/size_pricing") ?>
