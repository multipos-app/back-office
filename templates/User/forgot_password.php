              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small"><?= __ ('Enter your email and we will send you a reset email.') ?></p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate action="user/password-reset" method="post">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit"><?= __ ('Go') ?></button>
                    </div>
                  </form>
