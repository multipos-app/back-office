		  ...
		  <div style="padding-top:30px" class="panel-body">
				...
				<div class="form-group form-horizontal">
					 ...
					 <div style="margin-top:10px;margin-left:5px;" class="form-group">
						  <h4><?= __ ('A merchant with that email already exists.') ?></h4>
					 </div>

						  <div style="margin-top:10px" class="form-group">
								
								<div class="col-sm-12 controls">
									 <button type="submit" id="btn-login" class="btn btn-success" onclick="window.location = '/user/free-trial'"><?= __ ('Try again') ?></button>
								</div>
						  </div>
