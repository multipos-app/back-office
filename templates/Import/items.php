...
<div class="form-grid import-grid">
	 ...
	 <form id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="/pos-configs/import">			
		  ...
		  <div class="form-cell"></div>
		  <div class="form-cell l form-control-cell form-center">
				
			<button id="import_button" class="btn btn-secondary btn-block text-center" onclick="javascript:import ();"><?= __ ('Import') ?></button>
