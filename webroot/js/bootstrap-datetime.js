...
// ReSharper disable once InconsistentNaming
    DateTimePicker = function (element, options) {
        ...
        init = function () {
            ...
            picker.id = dpgId++;
            pMoment.locale(picker.options.localeuage);
            picker.date = pMoment();
            picker.unset = false;
        ...
        dataToOptions = function () {
            ...
            if (eData.localeuage !== undefined) picker.options.localeuage = eData.localeuage;
            ...
            return (
                '<div class="timepicker-picker">' +
                    '<table class="table-condensed">' +
						'<tr>' +
							'<td><button type="button" class="btn btn-time" data-action="incrementHours">+</i></button></td>' +
							'<td class="separator"></td>' +
							'<td>' + (picker.options.useMinutes ? '<button type="button" class="btn btn-time" data-action="incrementMinutes">+</i></button>' : '') + '</td>' +
                            (picker.options.useSeconds ?
                                '<td class="separator"></td><td><button type="button" class="btn btn-time" data-action="incrementSeconds">+</i></button></td>' : '') +
						...
						'</tr>' +
						'<tr>' +
							'<td><button type="button" class="btn btn-time" data-action="decrementHours">-</i></a></td>' +
							'<td class="separator"></td>' +
							'<td>' + (picker.options.useMinutes ? '<button type="button" class="btn btn-time" data-action="decrementMinutes">-</i></button>' : '') + '</td>' +
                            (picker.options.useSeconds ?
                                '<td class="separator"></td><td><button type="button" class="btn btn-time" data-action="decrementSeconds">-</i></button></td>' : '') +
							(picker.options.use24hours ? '' : '<td class="separator"></td>') +
						'</tr>' +
                    '</table>' +
                '</div>' +
